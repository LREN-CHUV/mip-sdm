import { CodeTransform, AutofixRegistration } from "@atomist/sdm";
import { CaptainFile, BuildScriptFile } from "../wellKnowFiles";
...
export const CaptainBuildScriptTransform: CodeTransform = async p => {
    return p.findFile(CaptainFile).then(async _ => {
